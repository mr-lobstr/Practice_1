...
SView Parser::get_value (SView value) {
...
TableColumn Parser::get_table_column (SView sv) {
...
void Parser::tables_names_check (TableColumnPairs const& tcPairs, TablesNames const& tablesNames) {
    HashSet<SView> names1 (tablesNames.begin(), tablesNames.end());
    HashSet<SView> names2;
